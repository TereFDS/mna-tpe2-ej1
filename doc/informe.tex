...
En el presente art\'iculo se describen dos programas: a) uno que, dado un archivo de sonido, indica el tono fundamental del mismo y crea una partitura asociada; y b) otro que, dado una partitura, crea el sonido correspondiente. Ambos est\'an implementados en Matlab y utilizan la escala de temperamento igual.
\end{abstract}
